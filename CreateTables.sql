...
--STORED PROCEDURE GetAllBookInfo

--AS

SELECT b.Title, b.YearPublished, a.LastName, a.FirstName, a.IsFemale, g.GenreName, l.LocationName
FROM Books as b
JOIN Authors as a ON a.Id = b.Author
JOIN Genres as g ON g.Id = b.Genre
JOIN Locations as l ON l.Id = b.Location
